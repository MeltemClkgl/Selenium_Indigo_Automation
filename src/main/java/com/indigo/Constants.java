...
public class Constants {
    ...
    public static final String EMAIL ="info@erdemcalikoglu.com";
    public static final String PASS = "Deneme123!";
    public static final String URL = "https://www.chapters.indigo.ca/en-ca/";
    public static final String KITAP ="The Analyst by John Katzenbach";
